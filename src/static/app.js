document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details, index = 0) {
    ...
    const formattedSchedule = escapeHtml(formatSchedule(details));
    ...
    activityCard.innerHTML = `
      ${tagHtml}
      <h4 id="activity-${activityId}">${escapedName}</h4>
          ...
          ${details.participants
            ...
            <li>
              ...
              ${
                currentUser
                  ? `
                <button class="delete-participant" data-activity="${escapedName}" data-email="${escapedEmail}" aria-label="Unregister ${escapedEmail} from ${escapedName}" title="Unregister this student">
      ...
      <div class="activity-card-actions">
        ${
          ...
          <button class="register-button" data-activity="${escapedName}" ${
              ...
              } aria-label="${isFull ? 'Activity is full' : `Register a student for ${escapedName}`}">
  ...
  function createShareButtons(activityName, description, schedule, index = 0) {
    ...
    return `
      <div class="share-container">
        <span class="share-label" id="share-label-${safeId}">Share this activity:</span>
        <div class="share-buttons" role="group" aria-labelledby="share-label-${safeId}">
          <button class="share-button share-button--facebook" 
                  data-platform="facebook" 
                  data-activity="${escapedName}"
                  data-description="${escapedDescription}"
                  aria-label="Share ${escapedName} on Facebook"
          ...
          <button class="share-button share-button--twitter" 
                  ...
                  data-activity="${escapedName}"
                  data-description="${escapedDescription}"
                  aria-label="Share ${escapedName} on X (Twitter)"
          ...
          <button class="share-button share-button--linkedin" 
                  ...
                  data-activity="${escapedName}"
                  data-description="${escapedDescription}"
                  aria-label="Share ${escapedName} on LinkedIn"
          ...
          <button class="share-button share-button--email" 
                  ...
                  data-activity="${escapedName}"
                  data-description="${escapedDescription}"
                  aria-label="Share ${escapedName} via Email"
